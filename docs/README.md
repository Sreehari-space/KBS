...
| D19 | The pastel/ink treatment is **scoped to first run** and never reaches the till           | Setup is the only screen in the product with no queue behind it; a pastel ground behind a cart list trades the counter's legibility for charm nobody there asked for.   | [09](09-premium-ui.md)            |
