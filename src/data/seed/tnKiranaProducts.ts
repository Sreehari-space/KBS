...
const ITEMS: SeedItem[] = [
  ...
  {
    en: 'Maggi Noodles 70g',
    ta: 'மேகி நூடுல்ஸ் 70கி',
    cat: 'Packaged',
    unit: 'piece',
    price: 1400,
    stock: 80,
  ...
  {
    en: 'Coconut Hair Oil 100ml',
    ta: 'தலை எண்ணெய் 100மி.லி',
    cat: 'Household',
    unit: 'piece',
    price: 4500,
    stock: 20,
